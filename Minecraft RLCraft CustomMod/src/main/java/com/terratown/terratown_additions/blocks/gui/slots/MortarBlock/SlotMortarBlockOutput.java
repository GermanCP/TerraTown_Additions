...
public class SlotMortarBlockOutput extends Slot {
	
	
	private final EntityPlayer player;
	private int removeCount;
	
	public SlotMortarBlockOutput(EntityPlayer player, IInventory inventory, int index, int x, int y)
	{
	...
	protected void onCrafting(ItemStack stack) {
        ...
        if (!this.player.world.isRemote)
        {
            ...
            float f = MortarRecipes.getInstance().getGrindingExperience(stack);
