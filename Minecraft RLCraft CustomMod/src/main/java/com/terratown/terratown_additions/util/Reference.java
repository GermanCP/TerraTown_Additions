package com.terratown.terratown_additions.util;

public class Reference {
	//mod data
	public static final String MOD_ID = "terratown_additions";
	public static final String NAME = "TerraTown Additions";
